...
namespace COGERTI.Controllers
{
    public class ComputadoresController : Controller
    {
        ...
        {
            var computadores = db.Computadores.Include(c => c.Funcionario).Include(c => c.LocalSite).Include(c => c.Propriedade).Include(c => c.StatusEquipamento).Include(c => c.TipoComputador);
        ...
        public ActionResult Create([Bind(Include = "Id,LocalSiteId,FuncionarioUPI,DataAssociacao,DataLiberacao,MotivoLiberacao,TermoResponsabilidade,SerialNo,Patrimonio,DataFabricacao,Marca,Modelo,PropriedadeId,StatusEquipamentoId,TipoComputadorId")] Computador computador)
        {
            ...
            ViewBag.FuncionarioUPI = new SelectList(db.Funcionarios, "UPI", "Nome", computador.FuncionarioUPI);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,LocalSiteId,FuncionarioUPI,DataAssociacao,DataLiberacao,MotivoLiberacao,TermoResponsabilidade,SerialNo,Patrimonio,DataFabricacao,Marca,Modelo,PropriedadeId,StatusEquipamentoId,TipoComputadorId")] Computador computador)
        {
            if (ModelState.IsValid)
            {
